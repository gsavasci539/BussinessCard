...
const SettingsScreen = ({navigation}) => {
  ...
  const colorOptions = [
    '#111827', '#1e40af', '#059669', '#7c3aed', '#dc2626', '#ea580c',
    '#0ea5e9', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#06b6d4'
  ];
  ...
  const qrUrl = profileData ? `https://kartvizit.app/${profileData.username}` : '';
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.settingsContainer}>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.label}>Renk Paleti</Text>
